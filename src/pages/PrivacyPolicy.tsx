  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 pb-20 pt-32 lg:px-8">
        <h1 className="mb-2 text-3xl font-bold text-foreground sm:text-4xl">{pp.title}</h1>
        <p className="mb-10 text-sm text-muted-foreground font-sans">Last updated: {pp.lastUpdated}</p>
